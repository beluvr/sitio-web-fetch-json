...
fetch(DATA_URL)
  ...
  .then(data => {
    ...
    showData(students); // Llama a la función showData con los datos obtenidos del JSON
  })
  .catch(error => {
    console.error('There has been a problem with your fetch operation:', error); // Maneja posibles errores en la operación fetch
  });
